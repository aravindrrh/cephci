...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        helper.assert_stat_uid_gid(client, f"{plain_mount}/own-test", IDMAP_BASE_UID, IDMAP_BASE_UID)
        ...
        helper.assert_stat_uid_gid(client, f"{plain_mount}/rootfile", IDMAP_BASE_UID, IDMAP_BASE_UID)
